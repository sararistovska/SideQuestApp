        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastMonthlyBonusDate = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredCategoryId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Badges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Badges_Categories_RequiredCategoryId",
            ...
            migrationBuilder.CreateTable(
                name: "QuestCompletionLikes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    QuestCompletionId = table.Column<int>(type: "INTEGER", nullable: false),
                    LikedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestCompletionLikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestCompletionLikes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestCompletionLikes_QuestCompletions_QuestCompletionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Badges_RequiredCategoryId",
                table: "Badges",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestCompletionLikes_QuestCompletionId",
                table: "QuestCompletionLikes",
                column: "QuestCompletionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestCompletionLikes_UserId_QuestCompletionId",
                table: "QuestCompletionLikes",
                columns: new[] { "UserId", "QuestCompletionId" },
                unique: true);
